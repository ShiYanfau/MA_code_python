...
def plot_confusion_matrix(y_true, y_pred, class_names, save_path, normalize=False):
    ...
    fig_width = max(7.0, 1.0 * len(class_names))
    fig_height = max(6.0, 0.85 * len(class_names))
...
def save_all_evaluation_plots(
    ...
    plot_classification_report(
        ...
        y_pred,
        class_names,
        os.path.join(save_dir, "classification_report.png"),
    )

    plot_roc_curve(
        id_energy,
        ood_energy,
        os.path.join(save_dir, "energy_score_roc.png"),
        "Energy Score ROC",
    )
    plot_roc_curve(
        id_dyn,
        ood_dyn,
        os.path.join(save_dir, "dynamics_score_roc.png"),
        "Dynamics Score ROC",
    )
    plot_roc_curve(
        id_fusion,
        ood_fusion,
        os.path.join(save_dir, "fusion_score_roc.png"),
        "Fusion Score ROC",
    )
    ...
    plot_score_distribution(
        id_energy,
        ood_energy,
        os.path.join(save_dir, "energy_score_distribution.png"),
    ...
    plot_score_distribution(
        id_dyn,
        ood_dyn,
        os.path.join(save_dir, "dynamics_error_distribution.png"),
        "Dynamics Error Distribution",
        "Dynamics error",
    )
    plot_score_distribution(
        id_fusion,
        ood_fusion,
        os.path.join(save_dir, "fusion_score_distribution.png"),
