...
def main():
    ...
    train_dataset = H5SplitDataset(args.h5_path, "train") # 创建训练集、验证集、测试集的 Dataset 实例
    val_dataset = H5SplitDataset(args.h5_path, "val")
    test_id_dataset = H5SplitDataset(args.h5_path, "test_id")
    test_ood_dataset = H5SplitDataset(args.h5_path, "test_ood")
